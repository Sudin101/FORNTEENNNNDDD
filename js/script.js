...
xhrFields:{
  ...
  function rowTemplate(hero) {
    ...
    oneRow += '<td><p><button type="button" class="btn btn-danger view" data-toggle="modal" data-target="#modalLRForm" post_id=' + hero._id + ' id="updatejobpost">view</button></tr></tr>';
    return oneRow;
}
...
tblBody.on('click', '#updatejobpost', function () {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + 'jobposts/' + $(this).attr('post_id'),
        success: function (heroes) {
